...
class constants$63 {
    ...
    static final MethodHandle io_uring_queue_init$MH = RuntimeHelper.downcallHandle(
        "io_uring_queue_init",
        constants$63.io_uring_queue_init$FUNC
    );
    ...
    static final MethodHandle io_uring_queue_mmap$MH = RuntimeHelper.downcallHandle(
        "io_uring_queue_mmap",
        constants$63.io_uring_queue_mmap$FUNC
    );
    ...
    static final MethodHandle io_uring_ring_dontfork$MH = RuntimeHelper.downcallHandle(
        ...
        constants$63.io_uring_ring_dontfork$FUNC
    );
    ...
    static final MethodHandle io_uring_queue_exit$MH = RuntimeHelper.downcallHandle(
        "io_uring_queue_exit",
        constants$63.io_uring_queue_exit$FUNC
    );
    ...
    static final MethodHandle io_uring_peek_batch_cqe$MH = RuntimeHelper.downcallHandle(
        ...
        constants$63.io_uring_peek_batch_cqe$FUNC
    );
    ...
    static final MethodHandle io_uring_wait_cqes$MH = RuntimeHelper.downcallHandle(
        "io_uring_wait_cqes",
        constants$63.io_uring_wait_cqes$FUNC
    );
}
